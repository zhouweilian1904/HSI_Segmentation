...
class LocalViT(nn.Module):
    def __init__(self, *, image_size = 25, patch_size = 5, num_classes = 20, dim = 64, depth = 4, heads = 4, mlp_dim = 64, channels = 20, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
    ...
    def forward(self, img, x_data):
        x = self.to_patch_embedding(img.squeeze(1))
        b, n, _ = x.shape
