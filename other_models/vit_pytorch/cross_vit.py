...
class CrossViT(nn.Module):
    def __init__(self, image_size, channels, num_classes, patch_size_small=14, patch_size_large=32, small_dim=64,
                 large_dim=64, small_depth=2, large_depth=2, cross_attn_depth=2, multi_scale_enc_depth=2,
                 heads=2, pool='cls', dropout=0.1, emb_dropout=0.1, scale_dim=4):
        super().__init__()
