...
class Speformer(nn.Module):
    def __init__(self, num_patches, num_classes, image_size, near_band=3, dim=64, depth=5, heads=4, mlp_dim=64,
                 pool='cls', channels=1, dim_head=64, dropout=0., emb_dropout=0., mode='CAF'):
        super().__init__()
