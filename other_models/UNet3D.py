...
class unet_3D(nn.Module):
    ...
    def forward(self, inputs, x_data = None):
        inputs = F.interpolate(inputs, size=(40, 224, 224), mode='trilinear', align_corners=False)
        ...
        out_seg = F.interpolate(final, size=(21, 21, 1), mode='trilinear', align_corners=False).squeeze(4)
